...
const Billing = () => {
    ...
    const handlePlaceOrder = () => {
        if (firstname && lastname && country && state && city && email && phone && address && zipcode) {
            ...
            dispatch(orderItem(firstname + " " + lastname, country, state, city, email, phone, address, zipcode, usertype, uid, status, cartdata, paymentMode,orderName, parseFloat((parseInt(totalPrice) + parseInt(shipping)) - discount).toFixed(2))).then(() => {
                        ...
                        <form action="" className='flex flex-col pl-3 sm:pl-9'>
                            ...
                            <div className='flex'>
                                <div className='flex flex-col mr-3'>
                                    ...
                                    <input type="text" placeholder={firstname ? firstname : `First name`} onChange={(e) => { setFirstName(e.target.value) }} className=' tracking-wide pl-3 text-xs sm:h-9 sm:w-[250px] w-[160px] border rounded border-[#1a1a1d43]' />
                                </div>
                                <div className='flex flex-col sm:mr-3'>
                                    <label htmlFor="" className=' text-xs sm:text-sm font-dmsans mb-[3px] text-white'>.</label>
                                    <input type="text" placeholder={lastname ? lastname : 'Last name'} onChange={(e) => { setLastName(e.target.value) }} className='tracking-wide pl-3 text-xs sm:h-9  sm:w-[250px] w-[160px] border rounded border-[#1a1a1d43]' />
                                </div>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <input type="text" className='sm:h-9 h-8 border rounded border-[#1a1a1d43] sm:w-full w-[335px] pl-3 text-[14px]' placeholder={address ? address : ''} onChange={(e) => { setAddress(e.target.value) }} />
                            </div>
                            ...
                            <div className='flex w-full'>
                                <div className='flex flex-col mr-3 sm:w-1/4 w-[160px]'>
                                    ...
                                    <input type="text" className='h-8 sm:h-9  border rounded border-[#1a1a1d43]' onChange={(e) => { setCountry(e.target.value) }} placeholder={country ? country : ''} />
                                </div>
                                <div className='flex flex-col mr-3 sm:w-1/4'>
                                    ...
                                    <input type="text" className='h-8 sm:h-9  border rounded border-[#1a1a1d43] text-xs pl-2' placeholder={state ? state : ""} onChange={(e) => { setState(e.target.value) }} />
                                </div>
                                <div className='hidden sm:flex flex-col mr-3 w-1/4'>
                                    <label htmlFor="" className='text-sm font-dmsans mb-[3px]'>City</label>
                                    <input type="text" className='h-9 border  rounded border-[#1a1a1d43] text-xs pl-2' placeholder={city ? city : ''} onChange={(e) => { setCity(e.target.value) }} />
                                </div>
                            ...
                            <div className='flex w-full'>
                                <div className='sm:hidden flex flex-col mr-3 w-[160px]'>
                                    ...
                                    <input type="text" className='h-8 sm:h-9 border  rounded border-[#1a1a1d43] text-xs pl-2' placeholder={city ? city : ''} onChange={(e) => { setCity(e.target.value) }} />
                                </div>
                                <div className='sm:hidden flex flex-col w-[160px]'>
                                    ...
                                    <input type="text" className='h-8 sm:h-9 border rounded border-[#1a1a1d43] text-xs pl-2' onChange={(e) => { setZipCode(e.target.value) }} placeholder={zipcode ? zipcode : ''} />
                                </div>
                            </div>
                            ...
                            <div className='flex w-full'>
                                <div className='flex flex-col mr-3 sm:w-1/2 w-[160px]'>
                                    ...
                                    <input type="text" className='h-8 sm:h-9  border rounded border-[#1a1a1d43] text-xs pl-2' onChange={(e) => { setEmail(e.target.value) }} placeholder={email ? email : ''} />
                                </div>
                                <div className='flex flex-col mr-3 sm:w-1/2 w-[160px]'>
