...
import { login, loginWithGoogle, loginWithOTP, sendEmailVerification, sendotp, signup } from '../../actions/User/UserAction';
      ...
      <div className='w-full h-screen flex justify-start items-start mt-[-60px]'>
        <div className='hidden sm:flex w-1/2 h-full flex-col justify-center items-center scale-50 lg:scale-100 '>
          <div className='h-[350px] w-[350px] justify-center items-center ml-60'>
            <img className='mandala max-h-full max-w-full' src={Mandala} alt="" />:
          </div>
        </div>
            ...
            <div className='border border-[#1a1a1d27] shadow-2xl w-[330px] sm:w-[400px] h-[740px]  sm:mr-32 rounded-md'>
              ...
              <form action="" onSubmit={registerUser}>
                <div className='text-pink w-full h-14 text-xl flex items-center font-semibold'>
                  ...
                  <span className='cursor-pointer h-full w-1/2 flex justify-center items-center border-b-2 border-red-500 text-red-600' onClick={toggleSignUp}>Sign Up</span>
                </div>
