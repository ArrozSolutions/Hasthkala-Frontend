          ...
          <div className='w-full h-screen flex justify-center items-center bg-[#1a1a1d22]'>
            <div className='shadow-xl w-[500px] h-[300px] bg-white rounded-xl pt-5'>
              <div className='flex flex-col w-full pl-10 pr-10'>
                ...
                <input onChange={(e) => { setFullname(e.target.value) }} type="text" placeholder='Enter Your Name' className='h-10 rounded border border-[#787878] text-sm' />
              </div>
              <div className='flex flex-col w-full pl-10 pr-10 mt-2'>
                <label htmlFor="" className='font-dmsans text-sm mt-2'>Email</label>
                <input onChange={(e) => { setEmail(e.target.value) }} type="text" placeholder='Enter Email' className='h-10 rounded border border-[#787878] text-sm' />
              </div>
              <div className='flex flex-col w-full pl-10 pr-10 mt-2'>
                <label htmlFor="" className='font-dmsans text-sm mt-2'>Password</label>
                <input onChange={(e) => { setPassword(e.target.value) }} type="text" placeholder='Enter Password' className='h-10 rounded border border-[#787878] text-sm' />
              </div>
              <div className='flex flex-col w-full pl-10 pr-10'>
                <button className='bg-red-600 text-white font-dmsans text-sm h-10 mt-4 rounded' onClick={handleCreateCredentials}>Create Credentials</button>
              </div>
            </div>
          </div>
        }
