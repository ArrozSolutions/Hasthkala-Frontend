  ...
  return (
    <>
      <div className='flex flex-col'>
        ...
        <br className='hidden sm:block' />
        {/* SEARCH  */}
        <div className='flex h-[50px] sm:h-[120px] w-full  xl:pl-20 xl:pr-20 pl-5 pr-5  sm:rounded relative items-center mt-10'>
          <div className='z-10 h-full w-full border border-[#DD2745] rounded-xl flex items-center justify-between'>
            ...
            <div className=' w-full sm:w-[190px] hidden sm:flex justify-center items-center z-0 relative bottom-8 left-16 '>
