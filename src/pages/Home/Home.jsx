    ...
    <>
      <div className='flex flex-col'>
        ...
        <div className='h-10 sm:h-28 mb-1 w-full flex items-center justify-end  text-lg sm:text-3xl text-[#1a1a1d]  flex-col'>
          <p className='font-alegreya font-semibold text-[#1a1a1d]'>Top Categories</p>
          <p className='text-[#888888] text-xs sm:text-lg'>Wide range of Gifts for your celebration</p>
        </div>
        {/* HEADING 1 */}
        ...
        <div className='h-5 sm:h-28  w-full flex flex-col items-start justify-end mt-12 text-lg sm:text-3xl sm:pl-20 pl-5'>
          <p className='font-alegreya text-[#1a1a1d] font-semibold'>Newly Added Products</p>
          <p className='text-[#888888] text-xs sm:text-lg'>Look for latest gifts</p>
        </div>
        {/* HEADING 2 */}
        ...
        <br className='hidden sm:block' />
        {/* SEARCH  */}
        <div className='flex h-[50px] sm:h-[100px] w-full  xl:pl-20 xl:pr-20 pl-5 pr-5  sm:rounded-full relative items-center mt-10'>
          <div className='z-10 h-full w-full border border-[#DD2745] rounded-full flex items-center justify-between'>
            <div className='flex flex-col pl-2 sm:pl-8'>
              <p className='uppercase text-[#DD2745] font-semibold text-xs sm:text-2xl  font-noto '>Find The Perfect Gift</p>
            ...
            <div className=' w-full sm:w-[150px] hidden sm:flex justify-center items-center z-0 relative bottom-8 left-16 '>
              <img src={GiftBoxes} className='absolute top-10 right-[200px] h-[80px] ' alt="" />
              <img className='h-full w-[120px] ml-8 sm:ml-0 sm:w-[450px]  z-40' src={GiftBoxes} alt="" />
            </div>


            <div className='flex pr-2 sm:pr-8'>
              <Link to={'/listing'}><button className='bg-[#dd2745] text-[#ffffff] text-[12px] sm:text-sm sm:w-[200px] h-[30px] w-[110px] sm:h-[65px] rounded-full'>Explore</button></Link>
            </div>
        ...
        <div className='flex flex-col min-h-[700px] items-center '>
          ...
          <div className='flex flex-col lg:flex-row pl-5 pr-5 sm:pl-20 sm:pr-20 max-[600px]:w-full '>
            ...
            <div className='flex flex-col justify-center sm:justify-start items-center sm:mr-8  sm:w-[360px] w-full'>
              <div className='w-[300px] sm:w-[360px] h-[220px] sm:h-[300px] mb-5'><img className='h-full w-full' src={Blog_Flowers} alt="" /></div>
            ...
            <div className='lg:hidden xl:flex flex-col w-full sm:w-[360px] justify-center items-center mt-8 sm:mt-0'>
              <div className='w-[300px] h-[180px] sm:w-[360px] sm:h-[240px] mb-5'><img className='h-full w-full' src={Blog_gifts} alt="" /></div>
              <div className='w-[300px] h-[180px] sm:w-[360px] sm:h-[240px]'><img className='h-full w-full' src={Blog_jewelery} alt="" /></div>
            </div>
          </div>
