...
import { BiCart, BiCheck, BiCoinStack, BiLogoStackOverflow, BiRotateRight, BiSolidTruck } from 'react-icons/bi';
import { Chart as ChartJS, ArcElement, Tooltip, Legend } from 'chart.js';
import { Doughnut } from "react-chartjs-2";
import { Chart } from 'react-charts'
import ReactApexCharts from 'react-apexcharts';
import { AdminAllOrders, AdminRecentOrders } from '../../actions/Admin/AdminAction';
                  ...
                  <tbody>
                    ...
                    {recentorders?.map((order, key) => (
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                          <span className='text-[#1371ff] font-semibold cursor-pointer'>Edit</span>
                        </td>
                      </tr>
                    ))
