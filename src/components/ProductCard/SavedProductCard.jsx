            ...
            <Link to={`/product/${slug}`} className='z-0'>
                <div className='flex flex-col shadow-xl w-full h-[235px] sm:h-[340px] rounded-xl  sm:rounded-bl-xl sm:rounded-br-xl sm:mr-10 border border-[#1a1a1d2e] relative'>
                    ...
                    <div className='w-full flex flex-col sm:pl-5 sm:pr-5 pl-2 pr-1'>
                        ...
                        <div className='w-full h-6 sm:h-7 mt-1 mb-2 pl-1 pr-2'><button className='h-full w-full flex items-center justify-center text-xs font-dmsans border rounded border-darkred hover:scale-110 transition-all duration-300'>Add To Cart</button></div>
                    </div>
                </div>
            </Link>
        </div>
