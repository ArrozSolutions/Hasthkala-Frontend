        ...
        <>
            <div className='flex h-14 sm:h-20 items-center justify-between pl-4 sm:pl-20 sm:pr-20 pr-4' >
                <div className='flex h-full w-[100px] sm:w-[200px] items-center justify-start'>
                    ...
                    <Link to={'/'}><div className='w-[45px] sm:w-[60px]  max-h-[60px] flex items-center font-alegreya text-red-600 '><img className='h-full w-full mr-1' src={Logo} alt="" /><span className=' sm:text-2xl'>HasthKala</span></div></Link>
                </div>
